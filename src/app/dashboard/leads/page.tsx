          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.85rem' }}>
            <thead>
              <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.1)', color: 'var(--text-secondary)' }}>
                ...
                <th style={{ padding: '0.8rem' }}>Tipo Crédito</th>
                <th style={{ padding: '0.8rem' }}>Presupuesto</th>
            ...
            <tbody>
              {filteredLeads.map(lead => (
                <tr key={lead.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                  ...
                  <td style={{ padding: '0.8rem', textTransform: 'capitalize' }}>{lead.creditType}</td>
                  <td style={{ padding: '0.8rem' }}>${lead.budgetMin?.toLocaleString()} - ${lead.budgetMax?.toLocaleString()}</td>
