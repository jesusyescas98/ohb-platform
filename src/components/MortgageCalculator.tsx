    ...
    <div className={`glass-panel ${styles.calculator}`}>
      ...
      <div className={styles.result}>
        ...
        <button 
          ...
          style={{ marginTop: '1.5rem', padding: '0.8rem 1.5rem', background: 'transparent', color: 'var(--accent-silver)', border: '1px solid var(--accent-silver)', borderRadius: '8px', cursor: 'pointer', fontFamily: 'var(--font-inter)', fontWeight: 'bold', transition: 'all 0.3s ease', width: '100%' }}
        >
